...
State transition_table[NUM_STATES][NUM_EVENTS] = {
    [STATE_WAITING] =
        {
            [event_play] = STATE_PLAY,
            [event_pause] = INVALID_STATE,
            [event_stop] = INVALID_STATE,
            [event_prev] = INVALID_STATE,
            [event_next] = INVALID_STATE,
        },

    [STATE_PLAY] =
        {
            [event_play] = INVALID_STATE,
            [event_pause] = STATE_PAUSE,
            [event_stop] = STATE_STOP,
            [event_prev] = STATE_PREV,
            [event_next] = STATE_NEXT,
        },
    [STATE_PAUSE] =
        {
            [event_play] = STATE_PLAY,
